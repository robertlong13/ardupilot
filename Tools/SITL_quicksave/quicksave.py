#!/usr/bin/env python3
"""Trigger a SITL quicksave via MAVLink over UDP 14553.

Uses the PREFLIGHT_REBOOT_SHUTDOWN developer magic sequence (42,24,71)
with param4=110, which the SITL build maps to "quicksave".
"""
import sys
from pymavlink import mavutil

CONN = 'udpin:0.0.0.0:14553'
PARAM4 = 110.0  # 110 = quicksave, 111 = quickload
